                                ...
                                @forelse($products as $category)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            @endif
                                        <td class="text-center">
                                            <span class="badge bg-info text-dark">Rp
                                                {{ number_format($category->price, 0, ',', '.') }}</span>
                                        </td>
                                        <td class="text-center">
                                            <span class="badge bg-info text-dark">{{ $category->stock}}</span>
                                        </td>
                                        </td>
                                        <td class="text-end pe-4">
                                            <div class="d-inline-flex align-items-center gap-1">
                                                ...
                                                <form action="{{ route('admin.products.destroy', $category) }}" method="POST"
                                    ...
                                    <div class="modal fade" id="editModal{{ $category->id }}" tabindex="-1">
                                        <div class="modal-dialog">
                                            <form class="modal-content" action="{{ route('admin.products.update', $category) }}"
